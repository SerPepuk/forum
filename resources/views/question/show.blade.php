                ...
                <div class="card-header">
                    ...
                    <div class="stats">
                        ...
                        <div>
                            ...
                            <span title="{{$replies->max('created_at')}}">{{\Carbon\Carbon::parse($replies->max('created_at'))->format('d/m/Y')}}</span>
                            @else
                ...
                <div class="card-body">
                    ...
                    <section class="replies-item" id="reply-{{$reply->id}}">
                        <div class="col-md-10 {{$reply->status == 'Ответ' ? 'answer' : 'replies-content'}}">
                            ...
                            <div class="stats">
                                <div>
                                    <form action="{{route('reply.like.store', $reply->id)}}" class="" method="POST">
                                        @csrf
