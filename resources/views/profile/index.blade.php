                        ...
                        <div class="container row">
                                        ...
                                        <div class="col-md-10">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <form action="{{ route('question.edit', $question->slug) }}"
                                                            method="get">
                                                            <button type="submit"
                                                                class="btn btn-outline-info">Изменить</button>
                                                        </form>
                                            ...
                                            <div class="stats">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        title="{{ $question->last_reply }}">{{ \Carbon\Carbon::parse($question->last_reply)->format('d/m/Y') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach ($user_replies as $reply)
                                    <div class="">
                                        <a class="col-md-9"
                                            href="{{ route('question.show', $reply->question->slug) }}">{{ $reply->question->title }}</a>
                                        <div
                                            class="col-md-12 {{ $reply->status == 'Ответ' ? 'answer' : 'replies-content' }}">
                                            <div class="replies-text">
                                                <p>{{ strlen(str_replace(['[code], [/code]'], '', $reply->description)) > 400
                                                    ...
                                                    : str_replace(['[code]', '[/code]'], ['', ''], $reply->description) }}
                                                </p>
                                            </div>
                                            <div class="stats">
                                                <div>
